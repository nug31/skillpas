        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#050505] [.theme-clear_&]:bg-slate-100 overflow-hidden pt-[env(safe-area-inset-top)]">
            ...
            <div className="relative flex flex-col items-center z-10 scale-110">
                ...
                <div className="relative w-80 min-h-[480px] rounded-3xl border border-white/10 [.theme-clear_&]:border-white/40 shadow-[0_0_40px_rgba(0,0,0,0.5)] [.theme-clear_&]:shadow-xl backdrop-blur-2xl overflow-hidden bg-white/5 [.theme-clear_&]:bg-white/60 pb-8">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-amber-900/10 [.theme-clear_&]:from-orange-500/10 [.theme-clear_&]:to-orange-500/10 pointer-events-none" />
                    ...
                    <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-white/5 to-transparent flex flex-col items-center justify-center border-b border-white/5">
                        <div className="text-[10px] tracking-[0.3em] font-medium text-amber-500 [.theme-clear_&]:text-orange-600 uppercase mb-1">Official Document</div>
                    ...
                    <div className="pt-24 px-6 flex flex-col items-center relative z-10">
                        <div className="relative mb-6 group">
                            <div className="absolute inset-[-4px] rounded-full bg-gradient-to-r from-amber-400 to-amber-600 blur-md opacity-70 group-hover:opacity-100 transition-opacity [.theme-clear_&]:from-orange-400 [.theme-clear_&]:to-orange-600" />
                        ...
                        {/* User Name */}
                        <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-white to-amber-200 [.theme-clear_&]:from-orange-600 [.theme-clear_&]:to-orange-600 mb-1 text-center">
                            {userName}
                        </h3>
                        ...
                        <div className="mt-8 w-full flex justify-center relative z-20">
                            ...
                            >
                                <div className="relative group cursor-default">
                                    ...
                                    {/* Stamp Circle */}
                                    <div className="w-32 h-32 rounded-full border-4 border-orange-400 [.theme-clear_&]:border-orange-600 flex flex-col items-center justify-center bg-orange-500/10 [.theme-clear_&]:bg-orange-100/50 backdrop-blur-md rotate-[-12deg] shadow-[0_0_20px_rgba(74,222,128,0.2)]">
                                        <Check className="w-12 h-12 text-orange-400 [.theme-clear_&]:text-orange-600 mb-1 drop-shadow-[0_0_5px_rgba(74,222,128,0.8)]" strokeWidth={4} />
                                        <span className="text-orange-400 [.theme-clear_&]:text-orange-600 font-black text-xs tracking-[0.2em]">VERIFIED</span>
                                        <span className="text-orange-300 [.theme-clear_&]:text-orange-700 text-[10px] mt-1 font-mono">
                                    ...
                                    {/* Ink effect */}
                                    {showStamp && (
                                        <div className="absolute inset-0 rounded-full animate-ping opacity-40 bg-orange-400" style={{ animationDuration: '0.6s', animationIterationCount: '1' }} />
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Decorative lines */}
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-amber-600 via-amber-400 to-amber-600 [.theme-clear_&]:from-orange-500 [.theme-clear_&]:via-orange-400 [.theme-clear_&]:to-orange-500" />
                </div>
                ...
                >
                    <h1 className="text-3xl font-black text-white [.theme-clear_&]:text-slate-800 mb-2 drop-shadow-lg">
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-300 via-white to-amber-300 [.theme-clear_&]:from-orange-600 [.theme-clear_&]:via-orange-600 [.theme-clear_&]:to-orange-600">
                            ACCESS GRANTED
                        </span>
                    </h1>
                    ...
                    <div className="flex justify-center gap-2 mt-6">
                        <div className="w-1.5 h-1.5 rounded-full bg-amber-500 [.theme-clear_&]:bg-orange-500 animate-bounce shadow-lg" style={{ animationDelay: '0ms' }} />
                        <div className="w-1.5 h-1.5 rounded-full bg-amber-400 [.theme-clear_&]:bg-orange-500 animate-bounce shadow-lg" style={{ animationDelay: '150ms' }} />
                        <div className="w-1.5 h-1.5 rounded-full bg-amber-300 [.theme-clear_&]:bg-orange-500 animate-bounce shadow-lg" style={{ animationDelay: '300ms' }} />
                    </div>
                </div>
            </div>
        </div>
