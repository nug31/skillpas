...
export function JurusanCard({ jurusan, onClick, topStudents, titleOverride }: JurusanCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="group relative card-glass rounded-xl hover-lift p-4 sm:p-6 text-left border border-white/6 hover:border-emerald-500/30 w-full shadow-lg hover:shadow-emerald-500/20 [.theme-clear_&]:border-slate-200 [.theme-clear_&]:shadow-sm"
    >
      ...
      <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
        <LucideIcons.ChevronRight className="w-5 h-5 text-emerald-500" />
      </div>
    </button>
  );
}
