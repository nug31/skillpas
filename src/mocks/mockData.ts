...
export const mockLevels: LevelSkill[] = [
  ...
  { id: LEVEL_IDS.MASTER, nama_level: 'Mastery (Expert)', urutan: 5, min_skor: 90, max_skor: 100, badge_name: 'Master', badge_color: '#f97316', criteria: ['Expert di bidangnya', 'Inovasi solusi baru', 'Mentoring Advanced member'], hasil_belajar: 'Ahli dan inovator di bidangnya', soft_skill: 'Mentoring', created_at: new Date().toISOString() },
];
