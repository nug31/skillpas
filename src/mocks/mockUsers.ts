...
export const mockUsers: User[] = [
    ...
    { id: 'w-f-xii-eli1', username: 'walas_feri_xii_elin1', password: '123', name: 'Feri Hapsara, S.Pd. Gr', role: 'wali_kelas', kelas: 'XII ELIND 1', jurusan_id: JURUSAN_IDS.ELIND },
    { id: 'w-s-xii-eli2', username: 'walas_septi_xii_elin2', password: '123', name: 'Septiawan Filtra Santosa, S.Pd, Gr', role: 'wali_kelas', kelas: 'XII ELIND 2', jurusan_id: JURUSAN_IDS.ELIND },
    { id: 'w-s-xii-eli3', username: 'walas_suhaimi_xii_elin3', password: '123', name: 'Ahmad Suhaimi, S.Pd', role: 'wali_kelas', kelas: 'XII ELIND 3', jurusan_id: JURUSAN_IDS.ELIND },
    { id: 'w-a-xii-eli4', username: 'walas_ambar_xii_elin4', password: '123', name: 'Ambar Tri Laksono, S.Pd,Gr.', role: 'wali_kelas', kelas: 'XII ELIND 4', jurusan_id: JURUSAN_IDS.ELIND },
    { id: 'w-s-xii-eli5', username: 'walas_septi_xii_elin5', password: '123', name: 'Septiawan Filtra Santosa, S.Pd, Gr', role: 'wali_kelas', kelas: 'XII ELIND 5', jurusan_id: JURUSAN_IDS.ELIND },
    ...
    { id: 'w-a-xii-ak1', username: 'walas_alyfia_xii_ak1', password: '123', name: 'Alyfia Azahra', role: 'wali_kelas', kelas: 'XII AK 1', jurusan_id: JURUSAN_IDS.AKUNTANSI },
    { id: 'w-a-xii-ak2', username: 'walas_alyfia_xii_ak2', password: '123', name: 'Alyfia Azahra', role: 'wali_kelas', kelas: 'XII AK 2', jurusan_id: JURUSAN_IDS.AKUNTANSI },
    { id: 'w-n-xii-ak3', username: 'walas_nida_xii_ak3', password: '123', name: 'Nida Apriliatul Hasanah, S.Pd', role: 'wali_kelas', kelas: 'XII AK 3', jurusan_id: JURUSAN_IDS.AKUNTANSI },
    { id: 'w-a-xii-hotel', username: 'walas_aula_xii_hotel', password: '123', name: 'Aula Al Layali, S.Pd', role: 'wali_kelas', kelas: 'XII HOTEL 1', jurusan_id: JURUSAN_IDS.HOTEL },
