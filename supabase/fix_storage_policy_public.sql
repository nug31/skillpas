-- FIX: Allow public/anonymous uploads
...
-- 1. Drop the previous restrictive policies (if they exist)
...
-- Ensure Select is still allowed (redundant if 'Public Access' exists, but safe to re-run)
